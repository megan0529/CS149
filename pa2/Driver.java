...
public class Driver {
   ...
   private static Runnable newTestRunner(String testRunnerName, int keyRange, int readPercent, int threads, int testTime, IntSet impl, boolean verbose) {
